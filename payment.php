...
<div class="container-fluid pl-5 pb-5 ">
    <div class="row">
        <div class="col-8">
            <div class="col-12 alert alert-primary text-bold">payment is accepted by only debit or credit card </div>
                <div class="row">
                            ...
                            <div class="card-body">
                                <form action="./index.php" name="payForm" onsubmit="return(payvalid());"  method="post" class="">
                                    ...
                                    <div class="form-gr`oup">
                                        <label for="x_zip" class="control-label mb-1">Name on the card</label>
